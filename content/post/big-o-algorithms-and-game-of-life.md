...
Today, we went over our [selector/DOM traversal exercise from yesterday]({{< ref "post/binary-search-trees-and-creating-a-javascript-library.md" >}}), and our instructors showed us some ES6 syntax. I thought the coolest one was array destructuring, which allows you to assign multiple variables to multiple array elements at once. For example, instead of doing this:
