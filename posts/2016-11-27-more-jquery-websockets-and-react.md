...
date: "2016-11-27"
subtitle: "Also: lots of food, Fantastic Beasts, and TV"
excerpt: "We ended class early on Wednesday because of the holiday. Given the couple of hours that we had, my pair and I primiarly worked on figuring out how to \"persist\" (at least until the server is reset) the hotels, restaurants, and activities that the user chooses on the days that they add them to."
---
