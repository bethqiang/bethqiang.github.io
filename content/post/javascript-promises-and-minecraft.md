...
After the [callback hell we experienced yesterday]({{< ref "post/sql-election-chat-and-revisiting-twitter-clone.md" >}}), we learned about promises today. A promise, according to my instructor and [the Promises/A+ Spec](https://promisesaplus.com/) and basically any other legitimate source, represents the **eventual result of an asynchronous operation**.
