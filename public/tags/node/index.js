...
<head>
  ...
  <title>Node.Js &middot; Beth Qiang</title>
  ...
  <!-- RSS autodiscovery -->
    ...
    <link href="http://bethqiang.com/tags/node.js/index.xml" rel="alternate" type="application/rss+xml" title="Beth Qiang" />
    <link href="http://bethqiang.com/tags/node.js/index.xml" rel="feed" type="application/rss+xml" title="Beth Qiang" />
...
<body class="home-template">
  ...
  <header>
    <h1 class="post-title"><a href="http://bethqiang.com/post/nodejs-interactive-north-america-2016/">Node.js Interactive North America 2016</a></h1>
    <div class="post-meta"><time datetime="November 30, 2016">November 30, 2016</time></div>
  </header>
  <section class="post-excerpt">
    <a class="excerptlink" href="http://bethqiang.com/post/nodejs-interactive-north-america-2016/"><p>Thanks to Women Who Code, I was given a ticket to Node.js Interactive North America, “the marquee event for JavaScript developers, companies that rely on Node.js, and the vendors that support both of these constituents.” The two days covered a wide spectrum of aspects and use cases for Node.js and its ecosystem.
In the opening keynotes alone, we heard from a wide variety of speakers and corresponding organizations. (The following list is not completely inclusive...</p></a>
    <p class="readmore"><a href="http://bethqiang.com/post/nodejs-interactive-north-america-2016/">Keep reading <i class="fa fa-angle-double-right" style="padding-left: 5px;"></i></a></p>
  </section>
</article>
 ...
 A place to store data (nothing fancy yet – just an object will do) A homepage that lists all tweets from all users A profile page that displays a specific user’s tweets A form to post new tweets (and as an extra bonus, enable it to update in real-time for all clients connected to the server at the time)  Initializing the Project First, we set up a twitter-js directory, and ran git init and npm init...</p></a>
  ...
  <section class="post-excerpt">
    ...
    <article class="preview">
  <header>
    <h1 class="post-title"><a href="http://bethqiang.com/post/game-of-life-and-introductory-nodejs/">Week 1, Day 5: Game of Life and Introductory Node.js</a></h1>
    <div class="post-meta"><time datetime="November 4, 2016">November 4, 2016</time></div>
  </header>
  <section class="post-excerpt">
    <a class="excerptlink" href="http://bethqiang.com/post/game-of-life-and-introductory-nodejs/"><p>We spent the first half of the day working on Conway’s Game of Life, which is probably one of the more widely known examples of cellular automaton. In this “game,” the player’s only interaction with the game is at the very beginning, when the board is first set. (It can also be set randomly, requiring no user input at all.) Each round after, cells “live” or “die” according to predetermined rules...</p></a>
    <p class="readmore"><a href="http://bethqiang.com/post/game-of-life-and-introductory-nodejs/">Keep reading <i class="fa fa-angle-double-right" style="padding-left: 5px;"></i></a></p>
  </section>
</article>
